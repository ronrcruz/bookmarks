...
//     return geo;
//   }, []);
//   const initialPos = useMemo(() => new THREE.Vector3(0, cardPos * 0.25 - 2, cardPos * -0.2 + 5), [cardPos]);
...
//         } else {
//           easing.damp3(state.camera.position, [state.camera.position.x, 0, 8], 1.0, delta);
//         }
//       }
//     }
//   });
